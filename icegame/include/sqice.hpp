...
/* Wish lists & TODOs
    Wishes:
        1. return list of information about system states
            like energy density, defect density and its location?
        2. Can we have a more general design for spin model to access Hamiltonian?
    TODOs:
        1.
    FIX:
        1.
...
class SQIceGame {
    public:
        ...
        void SetIce(vector<double> config);
...
BOOST_PYTHON_MODULE(icegame)
{
    ...
    class_<SQIceGame>("SQIceGame", init<INFO>())
        ...
        .def("longloop_algo", &SQIceGame::LongLoopAlgorithm)
